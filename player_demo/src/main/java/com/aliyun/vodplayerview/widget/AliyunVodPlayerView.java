...
public class AliyunVodPlayerView extends RelativeLayout implements ITheme {
    ...
    private OnChangeScreenModeListener mOnChangeScreenModeListener = null;
    ...
    private String videoId = ""; //记录播放的视频id
    private String SectionsId = "";//录播视频节id
    private int mCourseSectionsTime1 = 0;

    public String VideoIdGet(){
        return videoId;
    }

    public String SectionsIdGet(){
        return SectionsId;
    }

    public int CourseSectionsTimeGet(){
        return mCourseSectionsTime1;
    }

    public void VideoIdSet(String videoId,String SectionsId,int mCourseSectionsTime1){
...
//                    }
                ...
                if (mCurrentScreenMode == AliyunScreenMode.Small && mControlView != null) {
                    mControlView.hideMoreButton();
                }
            }
        });
...
//                    ((Activity) context).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                        ...
                        mOnChangeScreenModeListener.onChangeScreenModeFull();
                    } else {
                    ...
                    if (getLockPortraitMode() == null) {
                        ...
                        mOnChangeScreenModeListener.onChangeScreenModeSmall();
                    } else {
                        //如果是固定全屏，那么直接设置view的布局，宽高
                        ViewGroup.LayoutParams aliVcVideoViewLayoutParams = getLayoutParams();
    ...
    public void setActivetyContext(Context context){
        mContext = context;
    }
    /**
     * 获取当前屏幕模式：小屏、全屏
     ...
     * @param l 全屏显示事件监听
     */
    public void setOnChangeScreenModeListener(OnChangeScreenModeListener l) {
        mOnChangeScreenModeListener = l;
    }
...
//    }
    ...
    public void setTitleName(String title) {
        if (mControlView != null && !TextUtils.isEmpty(title)) {
