...
public class DatabaseManager {
    ...
    public static final String CREATE_TABLE_SQL = "create table if not exists " + DatabaseManager.TABLE_NAME +
            ...
            DatabaseManager.PARAM1 + " text," + DatabaseManager.PARAM2 + " text," +
            DatabaseManager.DURATION + " text," + DatabaseManager.SIZE + " text," +
            DatabaseManager.PROGRESS + " integer," + DatabaseManager.PARAM3 + " integer," + DatabaseManager.STATUS + " integer," +
    ...
    public long insert(AliyunDownloadMediaInfo mediaInfo) {
        ...
        contentValues.put(PARAM1,mediaInfo.getmParam1());
        contentValues.put(PARAM2,mediaInfo.getmParam2());
        contentValues.put(PARAM3,mediaInfo.getmParam3());
    ...
    public List<AliyunDownloadMediaInfo> selectDownloadingList(){
        ...
        while(cursor.moveToNext()){
            ...
            mediaInfo.setmParam1(cursor.getString(cursor.getColumnIndex(PARAM1)));
            mediaInfo.setmParam2(cursor.getString(cursor.getColumnIndex(PARAM2)));
            mediaInfo.setmParam3(cursor.getInt(cursor.getColumnIndex(PARAM3)));
            switch (status) {
                case 0:
                    //Idle
